 ...
 */
public class LoginActivityMecanix extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_activity_mecanix);
        ...
        Button mUserRegisterButton = (Button) findViewById(R.id.user_sig_in_button);
    ...
    private void jsonGenerateString(){
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginActivityMecanix.this,
    ...
    public class UserLoginTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                result = request.talkToOlimpus("requestLoginUser.php","json=" + jsonstring);
                return result;
            }
            catch (Exception ex) {
                Toast.makeText(LoginActivityMecanix.this,ex.toString(), Toast.LENGTH_SHORT).show();
                return null;
            }
        ...
        protected void onPostExecute(String success) {
            ...
            if (success.contains(":")) {
                Toast.makeText(LoginActivityMecanix.this, "Bienvenido " + messageWelcomeUser(success), Toast.LENGTH_LONG).show();
                startHomeActivity(success);
            } else {
    ...
    public String messageWelcomeUser(String json) {
    ...
    private void startHomeActivity(String result){

        Intent intent = new Intent(LoginActivityMecanix.this, SMenuActivity.class);
